defmodule Membrane.MP4.Plugin.MixProject do
  ...
  defp deps do
    [
      ...
      {:membrane_mp4_format,
       path: "/Users/jakubpryc/Membrane/membrane_mp4_format", override: true},
      {:membrane_cmaf_format, "~> 0.7.0"},
      {:membrane_aac_format,
       path: "/Users/jakubpryc/Membrane/membrane_aac_format", override: true},
      ...
      {:membrane_aac_plugin,
       path: "/Users/jakubpryc/Membrane/membrane_aac_plugin", override: true, only: :test},
