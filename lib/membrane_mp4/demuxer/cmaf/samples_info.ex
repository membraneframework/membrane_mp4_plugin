defmodule Membrane.MP4.Demuxer.CMAF.SamplesInfo do
  ...
  defp handle_track(traf_box) do
    ...
    Enum.filter(traf_box.children, fn {box_name, _box} -> box_name == :trun end) |> Enum.flat_map(fn {:trun, trun_box} -> 

    Enum.map_reduce(trun_box.fields.samples, base_data_offset + trun_box.fields.data_offset, fn sample, size_acc -> 
